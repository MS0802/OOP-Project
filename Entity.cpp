...
name(Name), position(startX, startY), hp(HP), maxHP(MaxHP), defense(def), maxDefense(def) {}

Entity::Entity() : position(0, 0), name(), effects(), maxHP(0), hp(0), defense(0), maxDefense(0) {}
...
int Entity::MaxDefense() const { return maxDefense; }
