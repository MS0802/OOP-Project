...
Potion Potion::Poison() { return Potion("Poison Potion", EffectType::POISON, 10, true); }
Potion Potion::Strength() { return Potion("Strength Potion", EffectType::STRENGTH, 10, false); }
Potion Potion::Weakness() { return Potion("Weakness Potion", EffectType::WEAKNESS, 10, true); }
Potion Potion::Resistance() { return Potion("Resistance Potion", EffectType::RESISTANCE, 10, false); }
Potion Potion::Vulnerability() { return Potion("Vulnerability Potion", EffectType::VULNERABLE, 10, true); }
